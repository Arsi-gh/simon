...
export default function MansionParts () {
  ...
  return (
    ...
    <section className='mt-16 mb-20 flex justify-center text-neutral-700 max-w-screen-xl mx-auto 2xl:max-w-screen-2xl max-lg:flex-col-reverse max-lg:gap-y-8 max-lg:mb-32'>
